...
(function (Drag) {
     ...
     */
    function convertTouchToMouseEvent(touch) {
        var touches = touch.touches;
        if (touches.length === 0)
            touches = touch.changedTouches; // touchEnd has no touches :facepalm:
        var mouse = new MouseEvent('fake-mouse', {
            button: 0,
            clientX: touches[0].clientX,
            clientY: touches[0].clientY,
        });
        // Forcefully add mouse event properties.
        mouse.preventDefault = touch.preventDefault;
        mouse.stopPropagation = touch.stopPropagation;
    ...
    Drag.convertTouchToMouseEvent = convertTouchToMouseEvent;
    /**
