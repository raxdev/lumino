    ...
    ***************************************************************************** */
    ...
    var DockLayout = /** @class */ (function (_super) {
        ...
        DockLayout.prototype._insertSplit = function (widget, ref, refNode, orientation, after) {
            ...
            if (splitNode.orientation === orientation) {
                ...
                algorithm.ArrayExt.insert(splitNode.sizers, j_1, Private$8.createSizer(s));
            ...
            algorithm.ArrayExt.insert(childNode.sizers, j, Private$8.createSizer(0.5));
    ...
    exports.TabBar = /** @class */ (function (_super) {
        ...
        TabBar.prototype.handleEvent = function (event) {
            switch (event.type) {
                case 'touchstart':
                    event = dragdrop.Drag.convertTouchToMouseEvent(event);
                case 'mousedown':
                    this._evtMouseDown(event);
                    break;
                case 'touchmove':
