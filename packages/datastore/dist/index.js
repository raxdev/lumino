(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@lumino/algorithm'), require('@lumino/collections'), require('@lumino/disposable'), require('@lumino/messaging'), require('@lumino/signaling')) :
    typeof define === 'function' && define.amd ? define(['exports', '@lumino/algorithm', '@lumino/collections', '@lumino/disposable', '@lumino/messaging', '@lumino/signaling'], factory) :
    (global = global || self, factory(global.lumino_datastore = {}, global.lumino_algorithm, global.lumino_collections, global.lumino_disposable, global.lumino_messaging, global.lumino_signaling));
}(this, (function (exports, algorithm, collections, disposable, messaging, signaling) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var Table = /** @class */ (function () {
        ...
        function Table(schema, context, records) {
            this._records = new collections.BPlusTree(Private.recordCmp);
            this.schema = schema;
    ...
    (function (Private) {
        ...
        function recordCmp(a, b) {
            return algorithm.StringExt.cmp(a.$id, b.$id);
        }
        ...
        function recordIdCmp(record, id) {
            return algorithm.StringExt.cmp(record.$id, id);
        }
     ...
     */
    exports.Datastore = /** @class */ (function () {
        /**
        ...
        function Datastore(context, tables, adapter, transactionIdFactory) {
            ...
            this._transactionQueue = new collections.LinkedList();
            this._context = context;
            this._tables = tables;
        ...
        Datastore.prototype.beginTransaction = function () {
            ...
            messaging.MessageLoop.postMessage(this, new messaging.ConflatableMessage('transaction-begun'));
            return id;
        };
        /**
        ...
        Datastore.prototype.toString = function () {
            return JSON.stringify(algorithm.toObject(algorithm.map(this, function (table) {
                return [table.schema.id, algorithm.toArray(table)];
            })));
        };
        /**
        ...
        Datastore.prototype._processTransaction = function (transaction, type) {
            ...
            var change = {};
            try {
                algorithm.each(algorithm.iterItems(patch), function (_a) {
        ...
        Datastore.prototype._queueTransaction = function (transaction, type) {
            ...
            messaging.MessageLoop.postMessage(this, new messaging.ConflatableMessage('queued-transaction'));
        };
        /**
    ...
    (function (Private) {
         ...
         */
        function recordCmp(a, b) {
            return algorithm.StringExt.cmp(a.schema.id, b.schema.id);
        }
        Private.recordCmp = recordCmp;
        /**
         * A three-way record id comparison function.
        ...
        function recordIdCmp(table, id) {
            return algorithm.StringExt.cmp(table.schema.id, id);
        }
        Private.recordIdCmp = recordIdCmp;
        /**
    ...
    (function (Private) {
        ...
        function findRemovedChunks(ids, metadata) {
            ...
            while (i < n) {
                ...
                var j = algorithm.ArrayExt.lowerBound(metadata.ids, ids[i], algorithm.StringExt.cmp);
                ...
                while (i < n && algorithm.StringExt.cmp(ids[i], metadata.ids[j]) === 0) {
                    count++;
                    i++;
                    j++;
                }
        ...
        function findInsertedChunks(ids, values, metadata) {
            ...
            for (var i = 0; i < ids.length; i++) {
                ...
                indices.push(algorithm.ArrayExt.lowerBound(metadata.ids, ids[i], algorithm.StringExt.cmp));
    ...
    (function (Private) {
        ...
        function insertIntoMetadata(metadata, key, id, value) {
            ...
            var i = algorithm.ArrayExt.lowerBound(ids, id, algorithm.StringExt.cmp);
            // Overwrite or insert the value as appropriate.
            if (i < ids.length && ids[i] === id) {
                values[i] = value;
            }
            else {
                algorithm.ArrayExt.insert(ids, i, id);
                algorithm.ArrayExt.insert(values, i, value);
            }
        ...
        function removeFromMetadata(metadata, key, id) {
            ...
            if (ids[i] === id) {
                algorithm.ArrayExt.removeAt(ids, i);
                algorithm.ArrayExt.removeAt(values, i);
            }
            // Return the current value for the key.
